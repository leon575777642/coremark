...
main_rv32_src_file = os.path.join(coremark_path, 'core_main_rv32.c')
...
-t {rv64_exe_file} | grep 'results\|static_memblk'"""
...
{main_rv32_src_file} {util_src_file} \
{list_src_file} {state_src_file} {matrix_src_file} \
-o {rv32_exe_file} \
...
if __name__ == "__main__":
  ...
  compile_rv64(iterations  = 1,
               debug_print = opts.debug_print)
  gen_rv32_header()
  compile_rv32(iterations = 1)
  create_mem_image()
